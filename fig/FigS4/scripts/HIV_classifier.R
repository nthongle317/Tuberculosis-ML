...
supp=grep("cg00782174|cg10140638|cg10453758|cg19616230|cg20098659|cg23181133", SigCpG, invert=T, value=T)

TB_dt=TB[TB$probeID%in%supp, names(TB)%in%c("probeID", TB_Sheet$Accession)]
...
ggsave(directory, "/fig/FigS4/figure/TB_HIV.selected.pdf", width=15, height=20)
ggsave(directory, "/fig/FigS4/figure/TB_HIV.selected.png", width=15, height=20)
