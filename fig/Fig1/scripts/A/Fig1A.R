...
input_dir=paste0(directory, "/fig/Fig1/data/A")
output_dir=paste0(directory, "/fig/Fig1/figure/A")

trainDT=data.frame(fread(paste0(input_dir, "/Fig1_heatmap.tsv")))
SigCpG=data.frame(fread(paste0(input_dir, "/DMPs.hg38.tsv")))$probeID
...
png(file=file.path(paste0(output_dir, "/heatmap_all.png")), width=800, height=600)
print(heatmap_plot)
dev.off()

pdf(file=file.path(paste0(output_dir, "/heatmap_all.pdf")), width=8, height=7)
print(heatmap_plot)
dev.off()
