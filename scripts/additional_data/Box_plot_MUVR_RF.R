...
output_dir=paste0("/media/thong/sda/RCID/CoHoai/Tuberculosis/data/test/Model/MUVR_RF")
...
pdf(file=file.path(paste0(output_dir, "/", "boxplot_2classs_MUVR-RF.pdf")), width = 20, height = 10)
