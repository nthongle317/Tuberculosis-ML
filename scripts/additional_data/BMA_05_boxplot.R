...
output_dir=paste0("/media/thong/sda/RCID/CoHoai/Tuberculosis/data/test/Model/BMA")
...
pdf(file.path(output_dir, "/Boosting_AUC_testDT.pdf"))
...
pdf(file.path(output_dir, "/BOOSTING_AUC_valDT.pdf"))
