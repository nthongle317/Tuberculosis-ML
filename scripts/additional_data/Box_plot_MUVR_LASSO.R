...
output_dir=paste0("/media/thong/sda/RCID/CoHoai/Tuberculosis/data/test/Model/LASSO")
...
pdf(file=file.path(paste0(output_dir, "/", "boxplot_2classs_LASSO.pdf")), width = 20, height = 10)
