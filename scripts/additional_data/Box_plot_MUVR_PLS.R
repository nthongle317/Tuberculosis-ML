...
directory = "/media/thong/sda/RCID/CoHoai/Tuberculosis"

input_dir=paste0("/media/thong/sda/RCID/CoHoai/Tuberculosis/data/dataInput")
output_dir=paste0("/media/thong/sda/RCID/CoHoai/Tuberculosis/data/test/Model/MUVR_PLS")
...
pdf(file=file.path(paste0(output_dir, "/", "boxplot_2classs_MUVR-PLS.pdf")), width = 20, height = 10)
